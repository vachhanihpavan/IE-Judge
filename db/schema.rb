...
ActiveRecord::Schema.define(version: 20180308174806) do
  ...
  create_table "problems", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.string "correct_code_file_name"
    t.string "correct_code_content_type"
    t.integer "correct_code_file_size"
    t.datetime "correct_code_updated_at"
  end
  ...
  create_table "solutions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "submitted_code_file_name"
    t.string "submitted_code_content_type"
    t.integer "submitted_code_file_size"
    t.datetime "submitted_code_updated_at"
  end
  ...
  create_table "users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.boolean "solver_role", default: true
